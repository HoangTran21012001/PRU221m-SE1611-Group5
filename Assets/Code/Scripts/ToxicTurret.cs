...
public class ToxicTurret : MonoBehaviour
{
    ...
    private void Shoot()
    {
        ...
        ToxicBullet bulletScript = bulletObj.GetComponent<ToxicBullet>();
    ...
    private void RotateTowardsTarget()
    {
        ...
        turretRotationPoint.rotation = Quaternion.RotateTowards(turretRotationPoint.rotation, targetRotation, rotaionSpeed * Time.deltaTime);
    }
